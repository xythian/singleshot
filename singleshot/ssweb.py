...
#
# layer on top ShotWeb (defining Singleshot in terms of a WSGI-complaint container)
#

#
# FIXME: Singleshot's core expects to be single-threaded, WSGI expects multi-thread containers to be OK
#
